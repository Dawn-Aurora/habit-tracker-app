...
describe('Habit Controller', () => {
  ...
  describe('getHabits', () => {
    it('should return all habits', async () => {
      const mockHabits = [
        { id: '1', Name: 'Exercise', Title: 'Exercise', CompletedDates: '2025-06-15,2025-06-16', userId: 'user123' },
        { id: '2', Name: 'Reading', Title: 'Reading', CompletedDates: '2025-06-17', userId: 'user123' }
      ];
  ...
  describe('createHabit', () => {    it('should create a new habit', async () => {
      ...
      expect(mockDataClient.createHabit).toHaveBeenCalledWith('New Habit', undefined, "", "", 'user123');
